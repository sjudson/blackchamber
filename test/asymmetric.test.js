          ...
          function decHandler(message, split) {
            return [
              ...
              function(req, res, next) {
                ...
                req.un.decrypt(req.c, req.n, function(err, m) {
                  if (err) { return next(err); }
          ...
          describe('without ciphertext', function() {
            ...
            before(function(done) {
              var handler = [
                bc('un', { asymmetric: { sk: keys.s_privatekey, pk: keys.r_publickey } }),
                function(req, res, next) {
                  req.un.decrypt(null, function(err, m) {
                    if (err) { return next(err); }
                  });
                },
                function(err, req, res, next) {
          ...
          describe('without nonce', function() {
            ...
            before(function(done) {
              var handler = [
                bc('un', { asymmetric: { sk: keys.s_privatekey, pk: keys.r_publickey } }),
                function(req, res, next) {
                  req.un.decrypt('d9d97c2b267c1be11af605f0682f6e9fbf02d77dd65d4942bdae3053cd4f1eba3c072180', function(err, m) {
                    if (err) { return next(err); }
                  });
                },
                function(err, req, res, next) {
          ...
          function encHandler(message) {
            return [
              ...
              function(req, res, next) {
                ...
                return req.bc.encrypt('asy', encrypted)(message);
              },
              function(req, res) {
                res.status(200).json({ ciphertext: req.c });
              }
          ...
          function decHandler(message, split) {
            return [
              ...
              function(req, res, next) {
                ...
                if (split) {
                  [req.c, req.n] = req.c.split('*');
                  return req.un.decrypt('asy', decrypted)(req.c, req.n);
                }

                return req.un.decrypt('asy', decrypted)(req.c);
              },
              function(req, res) {
                res.status(200).json({ plaintext: req.m });
              }
            ...
            before(function (done) {
              var handler = [
                ...
                function(req, res, next) {
                  ...
                  return req.bc.encrypt('asy', encrypted)();
                },
                function(err, req, res, next) {
                  res.status(400).json({ error: err.message });
                }
            ...
            before(function(done) {
              var handler = [
                ...
                function(req, res, next) {
                  ...
                  req.un.decrypt(c, function(err, m) {
                    if (err) { return next(err); }
                  });
                },
                function(err, req, res, next) {
            ...
            before(function(done) {
              var handler = [
                ...
                function(req, res, next) {
                  ...
                  return req.un.decrypt('asy', decrypted)();
                },
                function(err, req, res, next) {
                  res.status(400).json({ error: err.message });
                }
            ...
            before(function(done) {
              var handler = [
                ...
                function(req, res, next) {
                  ...
                  return req.un.decrypt('asy', decrypted)('d9d97c2b267c1be11af605f0682f6e9fbf02d77dd65d4942bdae3053cd4f1eba3c072180');
                },
                function(err, req, res, next) {
                  res.status(400).json({ error: err.message });
                }
